package com.testing.attendanceadmin_ai.appservice;
...
public class LocationTrack extends Service implements LocationListener {
    ...
    public void onLocationChanged(Location location) {
        ...
        float dist = distFrom((float)latitude,(float)longitude,(float)revisedLatitude,(float)revisedLongitude);
        Toast.makeText(mContext, "on Changed Distance"+dist, Toast.LENGTH_SHORT).show();
    }
